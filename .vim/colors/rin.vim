hi clear
syntax reset
let g:colors_name = "rin"
if &background == "light"
    hi Boolean gui=undercurl guisp=NONE guifg=#7d5f2b guibg=#fffff0
    hi ColorColumn gui=NONE guifg=NONE guibg=#eeeee2
    hi Comment gui=NONE guifg=#6c9d7c guibg=#fffff0
    ...
    hi CursorColumn gui=NONE guifg=NONE guibg=#eeeee2
    hi CursorLine gui=NONE guifg=NONE guibg=#eeeee2
    hi CursorLineNr gui=NONE guifg=#969696 guibg=#deded4
    ...
    hi ErrorMsg gui=NONE guifg=NONE guibg=#f18c83
    ...
    hi LineNr gui=NONE guifg=#6f6e77 guibg=#eeeee2
    hi MatchParen gui=NONE guifg=NONE guibg=#e3e3e3
    hi ModeMsg gui=NONE guifg=NONE guibg=NONE
    hi MoreMsg gui=NONE guifg=NONE guibg=NONE
    hi NonText gui=NONE guifg=#c2c2c2 guibg=NONE
    hi Normal gui=NONE guifg=#484b51 guibg=#fffff0
    hi Number gui=NONE guifg=#a51d31 guibg=NONE
    ...
    hi Statement gui=NONE guifg=#2b8fa1 guibg=NONE
    hi StatusLine gui=NONE guifg=#262626 guibg=#eeeee2
    hi StatusLineNC gui=NONE guifg=#969696 guibg=#ededed
    hi StorageClass gui=NONE guifg=#e3af02 guibg=NONE
    hi String gui=italic guifg=#f18c83 guibg=NONE
    hi TabLine gui=NONE guifg=#969696 guibg=#eeeee2
    hi TabLineFill gui=NONE guifg=NONE guibg=#eeeee2
    hi TabLineSel gui=NONE guifg=#262626 guibg=#fffff0
    hi Title gui=NONE guifg=#707070 guibg=NONE
    hi Todo gui=standout guifg=NONE guibg=NONE
    hi Type gui=italic guifg=#a51d31 guibg=NONE
    hi Underlined gui=NONE guifg=NONE guibg=NONE
    hi VertSplit gui=NONE guifg=#e3e3e3 guibg=NONE
    hi Visual gui=NONE guifg=NONE guibg=#e3e3e3
    hi VisualNOS gui=NONE guifg=NONE guibg=NONE
    hi WarningMsg gui=NONE guifg=NONE guibg=#f18c83
